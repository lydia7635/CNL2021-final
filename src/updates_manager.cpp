...
void UpdatesManager::WriteRequests(std::map<string, CLIENT*> client_table) {
    ...
    std::cout << "\n[UpdateManager] Update Manager was updated at: " << asctime(localtime(&last_updated_time)) << "(" << last_updated_time << ")" << "\n";
    last_updated_time = time(NULL);
    std::cout << "\n[UpdateManager] Update Manager is updating: " << asctime(localtime(&last_updated_time)) << "(" << last_updated_time << ")" << "\n";
...
void UpdatesManager::PushUpdates(std::map<string, CLIENT*> client_table) {
    ...
    for (Update *u : updates) {
        ...
        node.publish_time = u->publish_time;
